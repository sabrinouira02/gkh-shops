...
import { CCard, CCardBody, CContainer, CRow, CCol, CForm, CFormInput, CFormLabel, CFormTextarea, CFormSwitch, CButton, CInputGroup, CInputGroupText } from '@coreui/react-pro';
import { Head, Link, useForm } from '@inertiajs/react';
import { ArrowLeft, Save, Plus, Tag, Palette } from 'lucide-react';
...
export default function CategoryCreate() {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: t('add_category'), href: '/categories/create' },
    ];
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <CContainer fluid className="py-4">
                <div className="mb-4">
                    ...
                    <h2 className="fw-bold mb-0 text-body">{t('add_category')}</h2>
                </div>
                                ...
                                <CForm onSubmit={submit}>
                                        ...
                                        <CCol md={8}>
                                            <div className="mb-3">
                                                ...
                                                <CFormInput
                                                    ...
                                                    className="bg-body py-2 rounded-3 border-secondary-subtle"
                                                />
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <CFormTextarea
                                            ...
                                            rows={4}
                                            placeholder="Informations supplémentaires sur cette catégorie..."
